...
<div class="sunfarm py-4">
    ...
    <h2 class="mb-1" style="font-size: 24px !important;">Production Report</h2>
    <?php
    ...
    ?>
    <p class="mb-1" style="font-size: 9px !important;text-transform: uppercase;">FOR THE YEAR ENDED 31<sup>st</sup> DECEMBER {{Carbon\Carbon::now()->format('Y')}} | Generated On {{$day}}<sup>{{$symbol}}</sup> {{$year}} </p>
